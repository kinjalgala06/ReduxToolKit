...
const HabitStats: React.FC = () => {
  ...
  return (
    <Paper elevation={2} sx={{ p: 2, mt: 4 }}>
      ...
      <Typography variant="body1" align="left">Total Habits:{habits.length} </Typography>
      <Typography variant="body1" align="left">Completed Today:{getCompletedToday()}</Typography>
      <Typography variant="body1" align="left">Longest Streak:{getLongestStreak()}</Typography>
    </Paper>
  );
};
